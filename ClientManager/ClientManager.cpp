...
void ClientManager::init_textures() {
    ...
    gui_items.textura_list.add( "btn_incomming_yellow.bmp" ,  "btn_inc_y");
    gui_items.textura_list.add( "btn_outcomming_yellow.bmp" , "btn_out_y");
    gui_items.textura_list.add( "btn_autorun_yellow.bmp" ,    "btn_auto_y");
    
    gui_items.textura_list.add( "main_bg.bmp" , "main_bg");
    
    gui_items.textura_list.add( "btn_incomming_white.bmp" ,  "btn_inc_w");
    gui_items.textura_list.add( "btn_outcomming_white.bmp" , "btn_out_w");
